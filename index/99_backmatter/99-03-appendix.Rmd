...
records <- read.csv("data/c3/spp_records_pa.csv")
...
records_lg <- read.csv("data/c3/lower_glenelg_fox_pa.csv")
# load masks as dataframes (for covariates)
otways_mask_df <- readRDS("data/c3/otway_mask_df.RData")
glenelg_mask_df <- readRDS("data/c3/glenelg_mask_df.RData")
# load SECR capture histories - each session (but seperate unID from unmarked)
# mt clay (no black cats)
ch_mc <- readRDS("data/c3/ch_mc.RData")
unid_mc <- as.matrix(read.csv("data/c3/unid_mc.csv")[, -1]) 
mrch_mc <- addSightings(ch_mc, uncertain = unid_mc)
# hotspur 
ch_h <- readRDS("data/c3/ch_h.RData")
unid_h <- as.matrix(read.csv("data/c3/unid_h.csv")[, -1]) 
unm_h <- as.matrix(read.csv("data/c3/unm_h.csv")[, -1]) 
mrch_h <- addSightings(ch_h, unmarked = unm_h, uncertain = unid_h)
# annya 
ch_a <- readRDS("data/c3/ch_a.RData")
unid_a <- as.matrix(read.csv("data/c3/unid_a.csv")[, -1]) 
unm_a <- as.matrix(read.csv("data/c3/unm_a.csv")[, -1]) 
mrch_a <- addSightings(ch_a, unmarked = unm_a, uncertain = unid_a)
# cobbob 
ch_c <- readRDS("data/c3/ch_c.RData")
unid_c <- as.matrix(read.csv("data/c3/unid_c.csv")[, -1]) 
unm_c <- as.matrix(read.csv("data/c3/unm_c.csv")[, -1]) 
mrch_c <- addSightings(ch_c, unmarked = unm_c, uncertain = unid_c)
# LGNP north
ch_lgnpn <- read.capthist(captfile = "data/c3/LGNPN_caphist.txt", trapfile = "data/c3/LGNPN_traps.txt", detector = "proximity")
# LGNP south
ch_lgnps <- read.capthist(captfile = "data/c3/LGNPS_caphist.txt", trapfile = "data/c3/LGNPS_traps.txt", detector = "proximity")
# northern grid 2017 
ch_n_17 <- readRDS("data/c3/ch_n_17.RData")
unid_n_17 <- as.matrix(read.csv("data/c3/unid_n_17.csv")[, -1]) 
unm_n_17 <- as.matrix(read.csv("data/c3/unm_n_17.csv")[, -1]) 
mrch_n_17 <- addSightings(ch_n_17, unmarked = unm_n_17, uncertain = unid_n_17)
# northern grid 2018 
ch_n_18 <- readRDS("data/c3/ch_n_18.RData")
unid_n_18 <- as.matrix(read.csv("data/c3/unid_n_18.csv")[, -1]) 
unm_n_18 <- as.matrix(read.csv("data/c3/unm_n_18.csv")[, -1]) 
mrch_n_18 <- addSightings(ch_n_18, unmarked = unm_n_18, uncertain = unid_n_18)
# northern grid 2019 
ch_n_19 <- readRDS("data/c3/ch_n_19.RData")
unid_n_19 <- as.matrix(read.csv("data/c3/unid_n_19.csv")[, -1]) 
unm_n_19 <- as.matrix(read.csv("data/c3/unm_n_19.csv")[, -1]) 
mrch_n_19 <- addSightings(ch_n_19, unmarked = unm_n_19, uncertain = unid_n_19)
# southern grid 2017 
ch_s_17 <- readRDS("data/c3/ch_s_17.RData")
unid_s_17 <- as.matrix(read.csv("data/c3/unid_s_17.csv")[, -1]) 
unm_s_17 <- as.matrix(read.csv("data/c3/unm_s_17.csv")[, -1]) 
mrch_s_17 <- addSightings(ch_s_17, unmarked = unm_s_17, uncertain = unid_s_17)
# southern grid 2018 
ch_s_18 <- readRDS("data/c3/ch_s_18.RData")
unid_s_18 <- as.matrix(read.csv("data/c3/unid_s_18.csv")[, -1]) 
unm_s_18 <- as.matrix(read.csv("data/c3/unm_s_18.csv")  [, -1]) 
mrch_s_18 <- addSightings(ch_s_18, unmarked = unm_s_18, uncertain = unid_s_18)
# southern grid 2019 
ch_s_19 <- readRDS("data/c3/ch_s_19.RData")
unid_s_19 <- as.matrix(read.csv("data/c3/unid_s_19.csv")[, -1]) 
unm_s_19 <- as.matrix(read.csv("data/c3/unm_s_19.csv")[, -1]) 
...
# load masks
masks <- readRDS("data/c3/masks.RData")
# load SECR models
df_fits_glenelg <- readRDS("data/c3/glenelg_df_fits.RData")
glenelg_fits <- readRDS("data/c3/glenelg_fits.RData")
glenelg_set1 <- readRDS("data/c3/glenelg_set1.RData")
glenelg_set2 <- readRDS("data/c3/glenelg_set2.RData")
glenelg_set3 <- readRDS("data/c3/glenelg_set3.RData")
df_fits_otways <- readRDS("data/c3/otways_df_fits.RData")
otways_fits <- readRDS("data/c3/otways_fits.RData")
otways_set1 <- readRDS("data/c3/otways_set1.RData")
otways_set2 <- readRDS("data/c3/otways_set2.RData")
otways_set3 <- readRDS("data/c3/otways_set3.RData")
# load GAMs
gam_g_fox <- readRDS("data/c3/gam_g_fox.RData")
gam_o_fox <- readRDS("data/c3/gam_o_fox.RData")
```
...
knitr::include_graphics("figure/c3/camtrap1.jpg")
```
...
knitr::include_graphics("figure/c3/cat_coats.jpg")
```
...
knitr::include_graphics("figure/c3/fox_occ_se_glenelg_600dpi.png")
```
...
knitr::include_graphics("figure/c3/fox_occ_se_otways_600dpi.png")
```
